...
public class ZhihuNewsListBean implements Serializable{
     ...
     */
    public String date;
    public List<ZhihuNewsItemBean> stories;
    ...
    public List<ZhihuNewsItemBean> getStories() {
        return stories;
    }

    public void setStories(List<ZhihuNewsItemBean> stories) {
